...
#import "Sprites_LoadSpriteFromPVRCCZTest.h"

#pragma mark - Sprites_LoadSpriteFromPVRCCZTest

@implementation Sprites_LoadSpriteFromPVRCCZTest
...
-(NSString*)initTest{
    ...
    CGSize s = [CCDirector sharedDirector].winSize;
		...
		batchNodeParent = [CCSpriteBatchNode batchNodeWithFile:@"RES_Sprites_LoadSpriteFromPVRCCZTest/fruits_fruits.pvr.ccz" capacity:100];
		[self addChild:batchNodeParent z:0];
#endif
    
        //load into the sprite frame cache the plist generated by SH
        [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"RES_Sprites_LoadSpriteFromPVRCCZTest/fruits_fruits.plist"];

		[self executeTestCodeAtPosition:ccp(s.width/2, s.height/2)];
    
    return @"Tap to create sprites from PVR.CCZ image";
}
