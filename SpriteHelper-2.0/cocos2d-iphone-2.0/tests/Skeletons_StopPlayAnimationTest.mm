...
#import "Skeletons_StopPlayAnimationTest.h"


@implementation Skeletons_StopPlayAnimationTest
...
-(NSString*)initTest
{
    ...
    return @"\nDemonstrate stoping and playing a skeleton animation.\nTap on left side of the screen to stop animation.\nTap on right side of the screen to play animation.";
}
