...
#import "Sprites_LoadSpriteFromPVRTest.h"

#pragma mark - Sprites_LoadSpriteFromPVRTest

@implementation Sprites_LoadSpriteFromPVRTest
...
-(NSString*)initTest{
    ...
    CGSize s = [CCDirector sharedDirector].winSize;
		...
		batchNodeParent = [CCSpriteBatchNode batchNodeWithFile:@"RES_Sprites_LoadSpriteFromPVRTest/fruits_fruits.pvr" capacity:100];
		[self addChild:batchNodeParent z:0];
#endif
        

        //load into the sprite frame cache the plist generated by SH
        [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"RES_Sprites_LoadSpriteFromPVRTest/fruits_fruits.plist"];

		[self executeTestCodeAtPosition:ccp(s.width/2, s.height/2)];
    
    return @"Tap screen to create sprites from PVR image";
}
