...
#import "Skeletons_LoadTest.h"


@implementation Skeletons_LoadTest
...
-(NSString*)initTest
{
    ...
    return @"\nDemonstrate loading a skeleton.\nTouch and drag to move the left hand.\nAngle constraints comming soon...";
}
...
- (void)ccTouchesMoved:(NSSet *)touches withEvent:(UIEvent *)event{
	...
	for( UITouch *touch in touches ) {
        ...
        if(skeleton){
            [skeleton setPosition:location forBoneNamed:@"leftHand"];
        }
	}
}
