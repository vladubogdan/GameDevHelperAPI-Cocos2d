...
{    
    ...
    if(launchOptions && [[launchOptions objectForKey:@"GH_SET_AS_PORTRAIT"] boolValue])
    {
        navController_ = [[PortraitNavigationController alloc] initWithRootViewController:director_];
    }
    else{
